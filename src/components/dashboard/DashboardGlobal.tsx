...
const myTasks: TaskItem[] = [
  ...
  {
    id: 2,
    title: "Pembukaan Subdist Baru",
    description: "Pemberangkatan TAS ke Subdist 103851 - CNS Tangkot.",
    date: "24 Des 2026",
  ...
  },
  {
    id: 3,
    title: "SFA Task List",
    description: "Dokumen untuk membantu sales PHI",
    date: "24 Des 2026",
    dateColor: "text-red-500",
  },
]
...
function LeaderboardGlobal() {
  return (
    <div className="bg-white p-5 rounded-2xl border shadow-sm">
      <h2 className="font-semibold mb-4">Leader Global</h2>
    ...
    <div className="border rounded-xl p-3 space-y-1">
      ...
      {task.status && (
        <div className="flex items-center gap-1 mt-1">
          ...
          <span
            className={`text-xs px-2 py-0.5 rounded-full font-medium ${task.statusColor ?? ""}`}
          >
            {task.status}
          </span>
        </div>
      ...
      {task.date && (
        <div className="flex items-center gap-1 mt-1">
          ...
          <span className={`text-xs font-semibold ${task.dateColor ?? ""}`}>
            {task.date}
          </span>
        </div>
      )}
